...
--SELECT P.TITLE FROM POST AS P
--INNER JOIN POST_POST_CATEGORY_RELATION AS R
--    ON P.POST_ID = R.POST_ID
--INNER JOIN POST_CATEGORY AS C
--    ON C.POST_CATEGORY_ID = R.POST_CATEGORY_ID
--WHERE C.NAME = 'docker';

-- FUNKCJE Z PARAMETRAMI

CREATE OR REPLACE PROCEDURE GET_USER_EMAIL_BY_LOGIN(F_LOGIN IN VARCHAR2, OUT_EMAIL OUT VARCHAR2)
    IS
    TYPE ROW_TYPE IS RECORD ( EMAIL VARCHAR2(40));
    ROW_RESULT ROW_TYPE;
    CUR SYS_REFCURSOR;
BEGIN
    OPEN CUR FOR 'SELECT EMAIL FROM BLOG_USER WHERE LOGIN = ' || F_LOGIN;
    FETCH CUR INTO ROW_RESULT;
    OUT_EMAIL := ROW_RESULT.EMAIL;
END;
/

--GET_USER_EMAIL_BY_USERNAME('nezale');

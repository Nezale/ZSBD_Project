...
CREATE OR REPLACE FUNCTION IS_EMAIL_VALID(F_EMAIL VARCHAR2) RETURN BOOLEAN
IS
BEGIN
...
IS_VALID BOOLEAN;
BEGIN
IS_VALID := IS_EMAIL_VALID('jakismail@cos.com');
DBMS_OUTPUT.PUT_LINE('Is email valid ?: ' || BOOLEAN_TO_CHAR(IS_VALID));
